...
public:
    ...
    //for draw character
    osg::ref_ptr<osg::Group> charaTempGroup;
    osg::ref_ptr<osg::Vec3Array> charaVertexArray;
    osg::ref_ptr<osg::Geode> charaGeode;
    osg::ref_ptr<osg::Geometry> charaGeom;
    osg::ref_ptr<osg::DrawArrays> charaArray;
    bool DrawChara;
    void finishDrawChara();
