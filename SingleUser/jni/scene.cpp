...
void TestNumberedGeodeScene(osg::ref_ptr<osg::Group> & mainGroup,IDGeodeMap & IGM, ReverseIDGeodeMap & RIGM)
{
    ...
    mat1->setDiffuse(osg::Material::FRONT_AND_BACK,white);
    mat2->setDiffuse(osg::Material::FRONT_AND_BACK,red);
    mat3->setDiffuse(osg::Material::FRONT_AND_BACK,yellow);
    ...
    box1Geode->addDrawable(box1->getBoxGeometry(2.0*size,2.0*size,4.0*size,osg::Vec3(50.0,0.0,0.0)));
    box1Geode->getOrCreateStateSet()->setAttributeAndModes(mat1.get());
    box1Geode->getOrCreateStateSet()->setMode(GL_CULL_FACE,osg::StateAttribute::OFF);
    ...
    box2Geode->addDrawable(box2->getBoxGeometry(2.0*size,2.0*size,4.0*size,osg::Vec3(-50.0,0.0,0.0)));
    box2Geode->getOrCreateStateSet()->setAttributeAndModes(mat2.get());
    box2Geode->getOrCreateStateSet()->setMode(GL_CULL_FACE,osg::StateAttribute::OFF);
    ...
    box3Geode->addDrawable(box3->getBoxGeometry(2.0*size,2.0*size,4.0*size,osg::Vec3(0.0,50.0,0.0)));
    box3Geode->getOrCreateStateSet()->setAttributeAndModes(mat3.get());
    box3Geode->getOrCreateStateSet()->setMode(GL_CULL_FACE,osg::StateAttribute::OFF);
