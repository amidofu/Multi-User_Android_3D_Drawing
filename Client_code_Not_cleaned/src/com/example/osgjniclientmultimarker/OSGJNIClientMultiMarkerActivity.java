...
public class OSGJNIClientMultiMarkerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_osgjniclient_multi_marker);
        timer=new Timer();
    ...
    private OnClickListener OSGActivity = new OnClickListener(){
		...
		@Override
		public void onClick(View v) {
			Intent intent = new Intent(OSGJNIClientMultiMarkerActivity.this,OSGActivity.class);
